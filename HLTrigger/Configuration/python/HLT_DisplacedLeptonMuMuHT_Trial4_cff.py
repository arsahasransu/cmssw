...
# hltGetConfiguration --cff --offline /users/asahasra/SoftDisplaced/SoftDisplacedMuMuHT_Trial4 --globaltag auto:run3_hlt_GRun --unprescale

# /users/asahasra/SoftDisplaced/SoftDisplacedMuMuHT_Trial4/V2 (CMSSW_11_1_0)

fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/asahasra/SoftDisplaced/SoftDisplacedMuMuHT_Trial4/V2')
)
...
fragment.HLTriggerFirstPath = cms.Path( fragment.hltGetConditions + fragment.hltGetRaw + fragment.hltPSetMap + fragment.hltBoolFalse )
fragment.HLT_DoubleMu16NoFiltersNoVtxDisplaced_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sDoubleMu125to157 + fragment.hltPreDoubleMu16NoFiltersNoVtxDisplaced + fragment.hltL1fDimuonL1Filtered0 + fragment.HLTL2muonrecoSequenceNoVtx + cms.ignore(fragment.hltL2fDimuonL1f0L2NoVtxFiltered16) + fragment.HLTL3NoFiltersNoVtxmuonrecoSequence + fragment.hltL3fDimuonL1f0L2NVf16L3NoFiltersNoVtxFiltered16Displaced + fragment.HLTEndSequence )
fragment.HLTriggerFinalPath = cms.Path( fragment.hltGtStage2Digis + fragment.hltScalersRawToDigi + fragment.hltFEDSelector + fragment.hltTriggerSummaryAOD + fragment.hltTriggerSummaryRAW + fragment.hltBoolFalse )


fragment.HLTSchedule = cms.Schedule( *(fragment.HLTriggerFirstPath, fragment.HLT_DoubleMu16NoFiltersNoVtxDisplaced_v1, fragment.HLTriggerFinalPath ))
